...
def test_host_embedding_is_recommended_for_flash_next_on_a_small_card(tmp_path, monkeypatch):
    # qwen4_exp builds a host table for --host-embedding since the model reads the mark
